...
public class RequiredStructWithDefaultTests
{
    ...
    public void DirectMap_ShouldReturnValue_WhenValueNotNull()
    {
        ...
        var property = new RequiredStructWithDefaultProperty<RStructParameter, int>(parameters, defaultValue);
    ...
    public void FactoryMapClass_ShouldReturnValueObject_WhenValueNotNull()
    {
        ...
        var property = new RequiredStructWithDefaultProperty<RClassParameter, RClassValueObject>(parameters, defaultValue);
    ...
    public void FactoryMapStruct_ShouldReturnValueObject_WhenValueNotNull()
    {
        ...
        var value = 1;
        var parameters = new RStructParameter(value);
        var property = new RequiredStructWithDefaultProperty<RStructParameter, RStructValueObject>(parameters, defaultValue);
